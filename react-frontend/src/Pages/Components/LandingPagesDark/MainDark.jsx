// src/Pages/Components/LandingPagesDark/MainDark.jsx
import React from "react";
import { useNavigate } from "react-router-dom";
import FeatureCard from "../FeatureCard";

import ProtectIcon from "/src/assets/images/shield.png";
import Love from "/src/assets/images/love-dark.png";
import Community from "/src/assets/images/fluent_people-community-16-filled-dark.png";
...
export default function MainDark({ onShare, onReadStories }) {
  const navigate = useNavigate();
  const goShare = onShare ?? (() => navigate("/dark/share"));
  const goRead  = onReadStories ?? (() => navigate("/dark/comment"));
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-4 md:gap-[20px] mb-12">
          <button
            ...
            className="w-full md:w-[357px] h-[44px] px-[28px] rounded-[10px]
                       bg-[#C65C33] text-white flex items-center justify-center gap-[14px]
          ...
          <button
            ...
            className="w-full md:w-[201px] h-[44px] rounded-[10px]
                       ...
                       flex items-center justify-center gap-2 hover:bg-white/5"
          >
            Read Stories
        ...
        <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-[24px] md:gap-[36px] max-w-[980px] mx-auto">
          <FeatureCard
            ...
            className="w-full h-[230px] sm:h-[240px] md:h-[250px] bg-[#A84F1A] text-[#EEE3D9] border border-[#B36B1C]/30 shadow-[0_10px_24px_rgba(0,0,0,0.35)] transform-gpu transition-transform duration-300 ease-out hover:scale-[1.03] hover:-translate-y-1"
          />
          <FeatureCard
            icon={Love}
        ...
        <div className="mt-16 w-full flex justify-center">
          <div className="group w-full max-w-[900px]">
            <div
              className="rounded-[14px] px-[28px] md:px-[36px] py-[22px] md:py-[26px]
                         text-white border border-[#B36B1C]/40
                         shadow-[0_10px_24px_rgba(0,0,0,0.40)]
                         transform-gpu transition-transform duration-300 ease-out
                         hover:scale-[1.04] hover:-translate-y-1 hover:shadow-[0_18px_40px_rgba(0,0,0,0.45)]"
              style={{ background: "linear-gradient(99.79deg, #803113 -11.2%, #D96F32 92.2%)" }}
            >
              <h2 className="text-center font-aboreto text-[20px] md:text-[22px] mb-3">
                Your Safety Matters
              </h2>

              <p className="text-[15px] leading-[1.5] mb-2 text-white/90">
              ...
              <p className="text-[15px] leading-[1.5] mb-4 text-white/90">
              ...
              <div className="bg-[#EEE3D9] text-[#2B2521] rounded-[8px] text-sm py-2 px-4 font-abhaya flex justify-between gap-4 flex-wrap transform-gpu transition-transform duration-300 ease-out group-hover:scale-[1.02]">
