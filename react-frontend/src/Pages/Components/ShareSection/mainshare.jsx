    ...
    <main className="relative isolate bg-background text-darkText font-abhaya overflow-visible">
      ...
      <div className="relative z-10 max-w-[1100px] mx-auto px-4 md:px-4 py-8 md:py-1">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "linear-gradient(101.29deg, #F4C58B -25.63%, #D96F32 89.15%)",
          }}
        >
          <div className="flex items-center justify-between mb-2">
            <h2 className="text-[20px] md:text-[22px] font-bold">Your anonymous story</h2>
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="border border-[#000000] text-sm px-3 py-1 rounded flex items-center gap-1 hover:bg-[#D96F32] hover:text-white transition-colors"
        ...
        <div className="flex justify-center mt-5">
          <button
            ...
            className={`px-6 py-2 rounded-[10px] text-lg text-white font-abhaya
              ${canSubmit ? "bg-[#C65C33] hover:opacity-95 shadow-[0_8px_22px_rgba(198,92,51,0.35)]" : "bg-[#C65C33]/60 cursor-not-allowed"}`}
          >
            Review &amp; Submit
          </button>
        </div>
